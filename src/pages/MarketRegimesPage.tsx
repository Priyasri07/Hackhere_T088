  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="quant-card p-3.5 border-l-4 border-l-emerald-500">
        ...
        <div className="quant-card p-3.5 border-l-4 border-l-rose-500">
        ...
        <div className="quant-card p-3.5 border-l-4 border-l-amber-500">
        ...
        <div className="quant-card p-3.5 border-l-4 border-l-sky-500">
          <div className="text-xs font-bold text-sky-400 uppercase">Low Volatility</div>
          <div className="text-[11px] text-slate-300 font-mono mt-1">
