    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="quant-card p-4 flex flex-wrap items-center justify-between gap-3">
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: isActive ? `0 0 12px -2px ${info?.color}40` : undefined,
                  }}
                >
                  <span
        ...
        <div className="text-xs font-mono text-slate-400">
          Viewing <strong className="text-slate-200">{currentInfo?.name}</strong> ({currentInfo?.exchange})
        </div>
      </div>
      ...
      {currentMetrics && (
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">Latest Price</div>
            <div className="text-sm lg:text-base font-bold text-white font-mono mt-0.5">
              ${currentMetrics.latestPrice.toLocaleString()}
            </div>
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">USD Spot</div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">1D Return</div>
            <div
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Daily delta</div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">Total Return</div>
            <div
              className={`text-sm lg:text-base font-bold font-mono mt-0.5 ${
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">
              CAGR: {(currentMetrics.cagr * 100).toFixed(1)}%
            </div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">Avg Volume</div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Daily units</div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">Annualized Vol</div>
            <div className="text-sm lg:text-base font-bold text-amber-400 font-mono mt-0.5">
              {(currentMetrics.volatility * 100).toFixed(1)}%
            </div>
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Historical 252D</div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">SMA 50 / 200</div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Moving avg</div>
          </div>

          <div className="quant-card p-3">
            <div className="text-[10px] text-slate-500 uppercase font-semibold">EMA 12 / 26</div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Fast trend</div>
          </div>
          ...
          <div className="quant-card p-3">
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Peak decline</div>
          </div>
        </div>
      )}
